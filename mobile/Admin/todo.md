...
- [x] Upgrade Expo and React Native dependencies from SDK 54 to SDK 57
- [x] Run Expo Doctor and resolve SDK 57 compatibility issues
- [x] Validate the project with Expo Go SDK 57 and restart the preview
- [x] Apply the attached admin wireframe color palette and spacing system
- [x] Reorganize the dashboard into summary, attendance overview, quick access, upcoming activities, and recent requests sections
- [x] Align the admin bottom navigation with Home, Staff, Schedule, Notifications, and Profile
- [x] Add gallery and camera profile photo selection
- [x] Show the selected photo in the Profile screen and profile edit flow
- [x] Validate the profile photo uploader on TypeScript, lint, and preview
- [x] Allow shift and schedule assignment for all employees
- [x] Remove the Staff Terpilih activity option
- [x] Remove biometric login from Profile settings
- [x] Remove dummy records and show empty states for real data entry
- [x] Validate scheduling, empty states, and profile cleanup
- [x] Make daily schedule creation save a date, shift, and employee assignment reliably
- [x] Show saved daily assignments in the schedule and attendance context
- [x] Validate the daily schedule flow and prevent incomplete submissions
- [x] Remove the admin Tambah Pegawai action because employees create their own accounts
- [x] Correct shift setup so shifts are reusable for work schedules
- [x] Correct daily work-schedule assignment and attendance linkage
- [x] Validate employee, shift, and work-schedule flows
