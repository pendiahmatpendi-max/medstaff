...
export default function AttendanceConfirmationScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result =
        type === 'in'
          ? await clockIn(photoUri, latitude, longitude)
          : await clockOut(photoUri, latitude, longitude);

      if (!result?.success) {
        throw new Error(
          result?.message || 'Absensi gagal diproses.',
        );
      }

      Alert.alert(
        'Berhasil',
        result.message || `${typeText} berhasil.`,
        [
          {
            text: 'OK',
            onPress: () => {
      ...
      >
        <View style={styles.photoContainer}>
          ...
          <View style={styles.timeOverlay}>
            ...
            <Text style={styles.timeOverlayTime}>
              {timeString}
            </Text>
          </View>
        </View>
          ...
          <View style={styles.mapHeader}>
            ...
            <View style={{ marginLeft: 8 }}>
              ...
              <Text style={styles.mapSubtitle}>
                Sesuai dengan koordinat GPS Anda
              </Text>
            </View>
          </View>
